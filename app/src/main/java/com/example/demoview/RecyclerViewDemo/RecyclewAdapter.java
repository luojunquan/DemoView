 ...
 */
public class RecyclewAdapter extends RecyclerView.Adapter {
    private LayoutInflater inflater;
    private ArrayList<HashMap<String, Object>> listItem;
    private MyItemClickListener myItemClickListener;

    public RecyclewAdapter(Context context, ArrayList<HashMap<String, Object>> listItem) {
    ...
    class Viewholder extends RecyclerView.ViewHolder  {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new Viewholder(inflater.inflate(R.layout.list_recyclew_activity, null));
