package com.example.demoview.RecyclerViewDemo;
...
public class RecyclewActivity extends AppCompatActivity implements MyItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.recyclew_activity);
        initData();
        initView();
...
//        LinearLayoutManager layoutManager = new LinearLayoutManager(this);//使用线性布局
        ...
        recyclewAdapter = new RecyclewAdapter(this,listItem);
        recyclewAdapter.setOnItemClickListener(this);
